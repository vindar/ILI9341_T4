...
#define PIN_TOUCH_IRQ 3   // optional. Set this only if touch is connected on the same spi bus (otherwise, set it to 255)
#define PIN_TOUCH_CS  4   // optional. Set this only if touch is connected on the same spi bus (otherwise, set it to 255)
