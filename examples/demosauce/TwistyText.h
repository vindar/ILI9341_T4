...
void TwistyText::init(ILI9341Wrapper & tft) {
...
void TwistyText::reset(ILI9341Wrapper & tft) {
...
void TwistyText::perFrame(ILI9341Wrapper & tft, FrameParams frameParams ) {
