...
public:
  ...
  void init(ILI9341Wrapper & tft);
	void restart(ILI9341Wrapper & tft, uint_fast16_t color );
...
void TransitionScroll::init(ILI9341Wrapper & tft) {
	_pixels = (uint16_t*)malloc( sizeof(uint_fast16_t) * tft.width() );
}

void TransitionScroll::restart(ILI9341Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionScroll::perFrame(ILI9341Wrapper & tft, FrameParams frameParams ) {
