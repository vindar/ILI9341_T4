...
**Remark.** Two diff buffers are useful even when using double (and not triple buffering) and will provide a nice speed boost: **ADVICE: always use two diff buffers**.
